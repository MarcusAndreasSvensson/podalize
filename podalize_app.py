...
def test(uploaded_file: str=None, youtube_url=None, model_size = 'base'):
    if uploaded_file or youtube_url:
        # st.spinner(text="In progress...")
        if uploaded_file:
            p2audio = uploaded_file
        #     p2audio = os.path.join(uploaded_file)
        #     # p2audio = os.path.join(path2audios, uploaded_file)
        ...
        return [output, speakers, spoken_time, spoken_time_secs, spoken_fig, wc_figs]



if __name__ == "__main__":
    # test(uploaded_file="test.mp3")
    test(youtube_url="https://www.youtube.com/watch?v=2AV5YReL2Dc&ab_channel=AmeerPotiskumTV")
    # test(youtube_url="https://www.youtube.com/watch?v=y3iLOxBTuy4&ab_channel=Fireship")